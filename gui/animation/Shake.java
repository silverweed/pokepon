...
public class Shake extends BasicAnimation {
	...
	/** @param opts Opts:
	 * <ul>
	 *   <li>motionWidth: the width of the motion in pixel (default: 30)</li>
	 *   <li>style: either "harmonic", "linear" or "const" (default)</li>
	 *   <li>shakes: the number of shakes to do</li>
	 * </ul>
	 */
